package com.sorsix.urlShortener.controllers;

import com.sorsix.urlShortener.models.NewShort;
import com.sorsix.urlShortener.models.ShortUrl;
import com.sorsix.urlShortener.services.ShortUrlService;
...
public class ShortUrlController {
    ...
    public ResponseEntity addNewShort(@RequestBody NewShort newShort) {
        ...
        try {
            new URL(newShort.getNewShortUrl()).toURI();
            return ResponseEntity.ok().body(shortUrlService.newShortUrl(newShort.getNewShortUrl()));
        } catch (Exception exc) {
